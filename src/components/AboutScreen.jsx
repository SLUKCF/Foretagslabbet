...
export default function AboutScreen({ onBack }) {
  return (
    <div className="flex flex-col items-center justify-center text-center px-6 py-8 w-full max-w-3xl">
        ...
        <p className="text-lg mb-6">
            Bakom Företagslabbet står <span className="font-bold">Kunskapsnav företagsledning och entreprenörskap</span> och <span className="font-bold">HIR Skåne</span>, tillsammans med samarbetspartners som <span class="font-bold">Green Adviser</span>.
        </p>
